...
const JoinPadletComponent = () => {
  ...
  return (
    <div className='w-full h-full items-center justify py-16 flex flex-col bg-[rgba(255,255,255,.5)]'>
        <p className='text-base md:text-xl max-w-[80%] text-center my-8 login-text'>
        ...
        <h2 className='login-text text-3xl font-bold my-4'>Padlet code</h2>
          <input onChange={handleChange} type="text" className='px-4 w-[80%] md:w-[70%] rounded-full py-2 text-base md:text-xl border-none outline-none login-text mt-4 mb-2' placeholder="Enter the padlet code..."/>
        <button onClick={handleRedirect} className='w-[150px] border border-black flex items-center justify-center h-[40px] rounded-xl py-1 my-8 bg-black text-white font-normal text-base md:text-xl'>Join</button>
    </div>
  )
}
